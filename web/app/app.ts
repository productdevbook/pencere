import { bindPencere, PencereViewer } from "pencere"
import type { ImageItem, Item, Renderer } from "pencere"
...
export function setupApp(): void {
  ...
  const textRenderer: Renderer = {
    ...
    mount(item, { document: doc }) {
      ...
      wrap.style.cssText =
        "max-width:60ch;padding:2rem;color:inherit;font:inherit;text-align:center;"
